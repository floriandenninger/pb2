...
public final class Shell_UrlActivity extends elx implements amei {
    private emi l;
            ...
            try {
                try {
                    ...
                    if (a instanceof Shell_UrlActivity) {
                        this.l = new emi((Shell_UrlActivity) a, (fgj) ((eed) lM).a.jp.get(), (BandaidConnectionOpenerController) ((eed) lM).a.wx.get(), (ypa) ((eed) lM).a.B.get(), ((eed) lM).a.li(), (fay) ((eed) lM).a.nd.get(), (opn) ((eed) lM).a.wy.get(), (aifk) ((eed) lM).a.fS.get(), (alwk) ((eed) lM).e.get(), ((eed) lM).a.bj(), null, null, null, null);
                        l.close();
                        this.l.i = this;
                        return;
                    }
                    String valueOf = String.valueOf(emi.class);
    ...
    public final Intent i() {
        ...
        if (TextUtils.isEmpty(stringExtra)) {
            stringExtra = ykp.a(shell_UrlActivity, intent);
        }
        ...
        intent2.putExtra("developer_key", "AIzaSyA8eiZmM1FaDVjRy-df2KTyQ_vz_yYM39w").putExtra("app_package", shell_UrlActivity.getPackageName()).putExtra("app_version", zgx.c(shell_UrlActivity)).putExtra("client_library_version", alvw.b(11300)).putExtra("lightbox_mode", !intent.getBooleanExtra("force_fullscreen", false)).putExtra("window_has_status_bar", (shell_UrlActivity.getWindow().getAttributes().flags & 1024) == 0);
        if (stringExtra == null) {
            return intent2;
        }
    ...
    protected final boolean l(boolean z) {
        ...
        Shell_UrlActivity shell_UrlActivity = o.a;
        String a = ykp.a(shell_UrlActivity, shell_UrlActivity.getIntent());
        fgj fgjVar = o.b;
        fgjVar.e(fgjVar.n(data, a));
        o.c.j();
        return true;
    }
