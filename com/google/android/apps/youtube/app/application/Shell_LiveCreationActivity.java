...
public final class Shell_LiveCreationActivity extends eln implements amei {
    private emd l;
            ...
            try {
                ...
                try {
                    try {
                        Object lM = lM();
                        Activity a = ((eed) lM).a();
                        if (a instanceof Shell_LiveCreationActivity) {
                            this.l = new emd((Shell_LiveCreationActivity) a, (fhe) ((eed) lM).a.hS(), (alwk) ((eed) lM).e.get(), ((eed) lM).a.bj(), null, null, null);
                            l.close();
                            return;
                        }
                        String valueOf = String.valueOf(emd.class);
