...
public final class Shell_HomeActivity extends ell implements amei {
    private emc l;
    ...
    private final void p() {
        ...
        try {
            ...
            try {
                try {
                    Object lM = lM();
                    izr izrVar = (izr) ((eed) lM).a.nP.get();
                    ysy ysyVar = (ysy) ((eed) lM).a.as.get();
                    aloh li = ((eed) lM).a.li();
                    fcj fcjVar = new fcj((ypa) ((eed) lM).a.B.get(), (fbd) ((eed) lM).a.wu.get());
                    aadw aadwVar = (aadw) ((eed) lM).a.D.get();
                    Activity a = ((eed) lM).a();
                    if (a instanceof Shell_HomeActivity) {
                        this.l = new emc(izrVar, ysyVar, li, fcjVar, aadwVar, (Shell_HomeActivity) a, (alwk) ((eed) lM).e.get(), ((eed) lM).a.bj(), null, null, null, null);
                        l.close();
                        return;
                    }
                    String valueOf = String.valueOf(emc.class);
    ...
    protected final boolean l(boolean z) {
        ...
        if (ba == 0 || ba == 1) {
            ...
            boolean z2 = apdmVar.b;
            avdj avdjVar2 = o.d.b().u;
            if (avdjVar2 == null) {
                avdjVar2 = avdj.a;
            }
            apev apevVar2 = avdjVar2.g;
            if (apevVar2 == null) {
                apevVar2 = apev.a;
            }
            boolean z3 = apevVar2.i;
            if (z2 && !z3 && o.b.o()) {
                o.a.n();
            }
        }
