...
public final class Shell_SettingsActivity extends elt implements amei {
    private emg l;
        ...
        if (this.l == null) {
            ...
            try {
                ...
                try {
                    try {
                        Object lM = lM();
                        Object hY = ((eed) lM).a.hY();
                        Activity a = ((eed) lM).a();
                        if (a instanceof Shell_SettingsActivity) {
                            this.l = new emg((trp) hY, (Shell_SettingsActivity) a, (alwk) ((eed) lM).e.get(), ((eed) lM).a.bj(), null, null);
                            l.close();
                            return;
                        }
