...
public final class Shell_UploadActivity extends elv implements amei {
    private emh l;
                ...
                try {
                    ...
                    try {
                        try {
                            Object lM = lM();
                            Activity a = ((eed) lM).a();
                            if (a instanceof Shell_UploadActivity) {
                                this.l = new emh((Shell_UploadActivity) a, (alwk) ((eed) lM).e.get(), ((eed) lM).a.bj());
                                l.close();
                                return;
                            }
                            String valueOf = String.valueOf(emh.class);
