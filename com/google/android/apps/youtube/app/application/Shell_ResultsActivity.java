...
public final class Shell_ResultsActivity extends elr implements amei {
    private emf l;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        aloh li = ((eed) lM).a.li();
                        Activity a = ((eed) lM).a();
                        if (a instanceof Shell_ResultsActivity) {
                            this.l = new emf(li, (Shell_ResultsActivity) a, (alwk) ((eed) lM).e.get(), ((eed) lM).a.bj(), null, null, null, null);
                            l.close();
                            return;
                        }
                        String valueOf = String.valueOf(emf.class);
