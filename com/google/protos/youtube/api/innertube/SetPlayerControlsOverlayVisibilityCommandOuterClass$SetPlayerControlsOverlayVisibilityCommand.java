...
public final class SetPlayerControlsOverlayVisibilityCommandOuterClass$SetPlayerControlsOverlayVisibilityCommand extends aonm implements aooz {
    ...
    public static final aonk setPlayerControlsOverlayVisibilityCommand;
    public int b;
    public boolean c;
    ...
    static {
        ...
        aonm.registerDefaultInstance(SetPlayerControlsOverlayVisibilityCommandOuterClass$SetPlayerControlsOverlayVisibilityCommand.class, setPlayerControlsOverlayVisibilityCommandOuterClass$SetPlayerControlsOverlayVisibilityCommand);
        setPlayerControlsOverlayVisibilityCommand = aonm.newSingularGeneratedExtension(apxf.a, setPlayerControlsOverlayVisibilityCommandOuterClass$SetPlayerControlsOverlayVisibilityCommand, setPlayerControlsOverlayVisibilityCommandOuterClass$SetPlayerControlsOverlayVisibilityCommand, null, 344144775, aoqn.MESSAGE, SetPlayerControlsOverlayVisibilityCommandOuterClass$SetPlayerControlsOverlayVisibilityCommand.class);
    }
