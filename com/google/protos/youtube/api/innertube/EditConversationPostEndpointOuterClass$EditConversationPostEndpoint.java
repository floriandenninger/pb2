...
public final class EditConversationPostEndpointOuterClass$EditConversationPostEndpoint extends aonm implements aooz {
    public static final EditConversationPostEndpointOuterClass$EditConversationPostEndpoint a;
    private static volatile aopf b;
    public static final aonk editConversationPostEndpoint;
    ...
    static {
        ...
        aonm.registerDefaultInstance(EditConversationPostEndpointOuterClass$EditConversationPostEndpoint.class, editConversationPostEndpointOuterClass$EditConversationPostEndpoint);
        editConversationPostEndpoint = aonm.newSingularGeneratedExtension(apxf.a, editConversationPostEndpointOuterClass$EditConversationPostEndpoint, editConversationPostEndpointOuterClass$EditConversationPostEndpoint, null, 88564668, aoqn.MESSAGE, EditConversationPostEndpointOuterClass$EditConversationPostEndpoint.class);
    }
