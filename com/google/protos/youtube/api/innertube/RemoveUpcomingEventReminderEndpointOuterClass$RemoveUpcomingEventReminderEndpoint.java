...
public final class RemoveUpcomingEventReminderEndpointOuterClass$RemoveUpcomingEventReminderEndpoint extends aonm implements aooz {
    public static final RemoveUpcomingEventReminderEndpointOuterClass$RemoveUpcomingEventReminderEndpoint a;
    private static volatile aopf c;
    public static final aonk removeUpcomingEventReminderEndpoint;
    private int d;
    private byte e = 2;
    public String b = "";
    ...
    static {
        ...
        aonm.registerDefaultInstance(RemoveUpcomingEventReminderEndpointOuterClass$RemoveUpcomingEventReminderEndpoint.class, removeUpcomingEventReminderEndpointOuterClass$RemoveUpcomingEventReminderEndpoint);
        removeUpcomingEventReminderEndpoint = aonm.newSingularGeneratedExtension(apxf.a, removeUpcomingEventReminderEndpointOuterClass$RemoveUpcomingEventReminderEndpoint, removeUpcomingEventReminderEndpointOuterClass$RemoveUpcomingEventReminderEndpoint, null, 124510444, aoqn.MESSAGE, RemoveUpcomingEventReminderEndpointOuterClass$RemoveUpcomingEventReminderEndpoint.class);
    }
