...
public final class DeleteClipEngagementPanelCommandOuterClass$DeleteClipEngagementPanelCommand extends aonm implements aooz {
    public static final DeleteClipEngagementPanelCommandOuterClass$DeleteClipEngagementPanelCommand a;
    private static volatile aopf d;
    public static final aonk deleteClipEngagementPanelCommand;
    public int b;
    public apxf c;
    private byte e = 2;
    ...
    static {
        ...
        aonm.registerDefaultInstance(DeleteClipEngagementPanelCommandOuterClass$DeleteClipEngagementPanelCommand.class, deleteClipEngagementPanelCommandOuterClass$DeleteClipEngagementPanelCommand);
        deleteClipEngagementPanelCommand = aonm.newSingularGeneratedExtension(apxf.a, deleteClipEngagementPanelCommandOuterClass$DeleteClipEngagementPanelCommand, deleteClipEngagementPanelCommandOuterClass$DeleteClipEngagementPanelCommand, null, 358044308, aoqn.MESSAGE, DeleteClipEngagementPanelCommandOuterClass$DeleteClipEngagementPanelCommand.class);
    }
