...
public final class ShowChannelNotificationPreferenceDialogActionOuterClass$ShowChannelNotificationPreferenceDialogAction extends aonm implements aooz {
    ...
    public static final aonk showChannelNotificationPreferenceDialogAction;
    public autq b;
    private int d;
    private byte e = 2;
    ...
    static {
        ...
        aonm.registerDefaultInstance(ShowChannelNotificationPreferenceDialogActionOuterClass$ShowChannelNotificationPreferenceDialogAction.class, showChannelNotificationPreferenceDialogActionOuterClass$ShowChannelNotificationPreferenceDialogAction);
        showChannelNotificationPreferenceDialogAction = aonm.newSingularGeneratedExtension(apxf.a, showChannelNotificationPreferenceDialogActionOuterClass$ShowChannelNotificationPreferenceDialogAction, showChannelNotificationPreferenceDialogActionOuterClass$ShowChannelNotificationPreferenceDialogAction, null, 90188060, aoqn.MESSAGE, ShowChannelNotificationPreferenceDialogActionOuterClass$ShowChannelNotificationPreferenceDialogAction.class);
    }
