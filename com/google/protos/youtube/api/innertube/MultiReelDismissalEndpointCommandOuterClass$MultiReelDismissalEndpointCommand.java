...
public final class MultiReelDismissalEndpointCommandOuterClass$MultiReelDismissalEndpointCommand extends aonm implements aooz {
    public static final MultiReelDismissalEndpointCommandOuterClass$MultiReelDismissalEndpointCommand a;
    private static volatile aopf c;
    public static final aonk multiReelDismissalEndpointCommand;
    public aulq b;
    private int d;
    private byte e = 2;
    ...
    static {
        ...
        aonm.registerDefaultInstance(MultiReelDismissalEndpointCommandOuterClass$MultiReelDismissalEndpointCommand.class, multiReelDismissalEndpointCommandOuterClass$MultiReelDismissalEndpointCommand);
        multiReelDismissalEndpointCommand = aonm.newSingularGeneratedExtension(apxf.a, multiReelDismissalEndpointCommandOuterClass$MultiReelDismissalEndpointCommand, multiReelDismissalEndpointCommandOuterClass$MultiReelDismissalEndpointCommand, null, 187251317, aoqn.MESSAGE, MultiReelDismissalEndpointCommandOuterClass$MultiReelDismissalEndpointCommand.class);
    }
