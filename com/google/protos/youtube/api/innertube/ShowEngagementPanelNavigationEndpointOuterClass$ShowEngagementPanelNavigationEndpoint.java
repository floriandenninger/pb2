...
public final class ShowEngagementPanelNavigationEndpointOuterClass$ShowEngagementPanelNavigationEndpoint extends aonm implements aooz {
    public static final ShowEngagementPanelNavigationEndpointOuterClass$ShowEngagementPanelNavigationEndpoint a;
    private static volatile aopf e;
    public static final aonk showEngagementPanelNavigationEndpoint;
    public int b;
    public String c = "";
    public boolean d;
    ...
    static {
        ...
        aonm.registerDefaultInstance(ShowEngagementPanelNavigationEndpointOuterClass$ShowEngagementPanelNavigationEndpoint.class, showEngagementPanelNavigationEndpointOuterClass$ShowEngagementPanelNavigationEndpoint);
        showEngagementPanelNavigationEndpoint = aonm.newSingularGeneratedExtension(apxf.a, showEngagementPanelNavigationEndpointOuterClass$ShowEngagementPanelNavigationEndpoint, showEngagementPanelNavigationEndpointOuterClass$ShowEngagementPanelNavigationEndpoint, null, 163501208, aoqn.MESSAGE, ShowEngagementPanelNavigationEndpointOuterClass$ShowEngagementPanelNavigationEndpoint.class);
    }
