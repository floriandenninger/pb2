...
public final class CreationEntryEndpointOuterClass$CreationEntryEndpoint extends aonm implements aooz {
    public static final CreationEntryEndpointOuterClass$CreationEntryEndpoint a;
    private static volatile aopf c;
    public static final aonk creationEntryEndpoint;
    public apmt b;
    private int d;
    private byte e = 2;
    ...
    static {
        ...
        aonm.registerDefaultInstance(CreationEntryEndpointOuterClass$CreationEntryEndpoint.class, creationEntryEndpointOuterClass$CreationEntryEndpoint);
        creationEntryEndpoint = aonm.newSingularGeneratedExtension(apxf.a, creationEntryEndpointOuterClass$CreationEntryEndpoint, creationEntryEndpointOuterClass$CreationEntryEndpoint, null, 144891985, aoqn.MESSAGE, CreationEntryEndpointOuterClass$CreationEntryEndpoint.class);
    }
