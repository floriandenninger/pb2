...
public final class UpdateHorizontalCardListActionEndpointOuterClass$UpdateHorizontalCardListActionEndpoint extends aonm implements aooz {
    public static final UpdateHorizontalCardListActionEndpointOuterClass$UpdateHorizontalCardListActionEndpoint a;
    private static volatile aopf c;
    public static final aonk updateHorizontalCardListActionEndpoint;
    private byte d = 2;
    ...
    static {
        ...
        aonm.registerDefaultInstance(UpdateHorizontalCardListActionEndpointOuterClass$UpdateHorizontalCardListActionEndpoint.class, updateHorizontalCardListActionEndpointOuterClass$UpdateHorizontalCardListActionEndpoint);
        updateHorizontalCardListActionEndpoint = aonm.newSingularGeneratedExtension(apxf.a, updateHorizontalCardListActionEndpointOuterClass$UpdateHorizontalCardListActionEndpoint, updateHorizontalCardListActionEndpointOuterClass$UpdateHorizontalCardListActionEndpoint, null, 149801128, aoqn.MESSAGE, UpdateHorizontalCardListActionEndpointOuterClass$UpdateHorizontalCardListActionEndpoint.class);
    }
