...
public final class RequestVerificationCodeEndpointOuterClass$RequestVerificationCodeEndpoint extends aonm implements aooz {
    public static final RequestVerificationCodeEndpointOuterClass$RequestVerificationCodeEndpoint a;
    private static volatile aopf b;
    public static final aonk requestVerificationCodeEndpoint;
    ...
    static {
        ...
        aonm.registerDefaultInstance(RequestVerificationCodeEndpointOuterClass$RequestVerificationCodeEndpoint.class, requestVerificationCodeEndpointOuterClass$RequestVerificationCodeEndpoint);
        requestVerificationCodeEndpoint = aonm.newSingularGeneratedExtension(apxf.a, requestVerificationCodeEndpointOuterClass$RequestVerificationCodeEndpoint, requestVerificationCodeEndpointOuterClass$RequestVerificationCodeEndpoint, null, 130003709, aoqn.MESSAGE, RequestVerificationCodeEndpointOuterClass$RequestVerificationCodeEndpoint.class);
    }
