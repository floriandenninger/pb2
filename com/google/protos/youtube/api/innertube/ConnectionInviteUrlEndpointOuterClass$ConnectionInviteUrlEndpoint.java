...
public final class ConnectionInviteUrlEndpointOuterClass$ConnectionInviteUrlEndpoint extends aonm implements aooz {
    public static final ConnectionInviteUrlEndpointOuterClass$ConnectionInviteUrlEndpoint a;
    private static volatile aopf b;
    public static final aonk connectionInviteUrlEndpoint;
    ...
    static {
        ...
        aonm.registerDefaultInstance(ConnectionInviteUrlEndpointOuterClass$ConnectionInviteUrlEndpoint.class, connectionInviteUrlEndpointOuterClass$ConnectionInviteUrlEndpoint);
        connectionInviteUrlEndpoint = aonm.newSingularGeneratedExtension(apxf.a, connectionInviteUrlEndpointOuterClass$ConnectionInviteUrlEndpoint, connectionInviteUrlEndpointOuterClass$ConnectionInviteUrlEndpoint, null, 105643691, aoqn.MESSAGE, ConnectionInviteUrlEndpointOuterClass$ConnectionInviteUrlEndpoint.class);
    }
