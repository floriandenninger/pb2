...
public final class RemoveFromRemoteQueueEndpointOuterClass$RemoveFromRemoteQueueEndpoint extends aonm implements aooz {
    public static final RemoveFromRemoteQueueEndpointOuterClass$RemoveFromRemoteQueueEndpoint a;
    private static volatile aopf c;
    public static final aonk removeFromRemoteQueueEndpoint;
    private int d;
    private byte e = 2;
    public String b = "";
    ...
    static {
        ...
        aonm.registerDefaultInstance(RemoveFromRemoteQueueEndpointOuterClass$RemoveFromRemoteQueueEndpoint.class, removeFromRemoteQueueEndpointOuterClass$RemoveFromRemoteQueueEndpoint);
        removeFromRemoteQueueEndpoint = aonm.newSingularGeneratedExtension(apxf.a, removeFromRemoteQueueEndpointOuterClass$RemoveFromRemoteQueueEndpoint, removeFromRemoteQueueEndpointOuterClass$RemoveFromRemoteQueueEndpoint, null, 64982798, aoqn.MESSAGE, RemoveFromRemoteQueueEndpointOuterClass$RemoveFromRemoteQueueEndpoint.class);
    }
