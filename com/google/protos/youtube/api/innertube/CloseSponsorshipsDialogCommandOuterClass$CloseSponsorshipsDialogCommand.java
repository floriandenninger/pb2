...
public final class CloseSponsorshipsDialogCommandOuterClass$CloseSponsorshipsDialogCommand extends aonm implements aooz {
    public static final CloseSponsorshipsDialogCommandOuterClass$CloseSponsorshipsDialogCommand a;
    private static volatile aopf b;
    public static final aonk closeSponsorshipsDialogCommand;
    ...
    static {
        ...
        aonm.registerDefaultInstance(CloseSponsorshipsDialogCommandOuterClass$CloseSponsorshipsDialogCommand.class, closeSponsorshipsDialogCommandOuterClass$CloseSponsorshipsDialogCommand);
        closeSponsorshipsDialogCommand = aonm.newSingularGeneratedExtension(apxf.a, closeSponsorshipsDialogCommandOuterClass$CloseSponsorshipsDialogCommand, closeSponsorshipsDialogCommandOuterClass$CloseSponsorshipsDialogCommand, null, 252663493, aoqn.MESSAGE, CloseSponsorshipsDialogCommandOuterClass$CloseSponsorshipsDialogCommand.class);
    }
