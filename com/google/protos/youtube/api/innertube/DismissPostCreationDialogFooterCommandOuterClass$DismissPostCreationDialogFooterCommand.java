...
public final class DismissPostCreationDialogFooterCommandOuterClass$DismissPostCreationDialogFooterCommand extends aonm implements aooz {
    public static final DismissPostCreationDialogFooterCommandOuterClass$DismissPostCreationDialogFooterCommand a;
    private static volatile aopf b;
    public static final aonk dismissPostCreationDialogFooterCommand;
    ...
    static {
        ...
        aonm.registerDefaultInstance(DismissPostCreationDialogFooterCommandOuterClass$DismissPostCreationDialogFooterCommand.class, dismissPostCreationDialogFooterCommandOuterClass$DismissPostCreationDialogFooterCommand);
        dismissPostCreationDialogFooterCommand = aonm.newSingularGeneratedExtension(apxf.a, dismissPostCreationDialogFooterCommandOuterClass$DismissPostCreationDialogFooterCommand, dismissPostCreationDialogFooterCommandOuterClass$DismissPostCreationDialogFooterCommand, null, 368549163, aoqn.MESSAGE, DismissPostCreationDialogFooterCommandOuterClass$DismissPostCreationDialogFooterCommand.class);
    }
