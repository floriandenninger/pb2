...
public class GvrSurfaceView extends SurfaceView implements SurfaceHolder.Callback2 {
    ...
    class DefaultContextFactory implements GLSurfaceView.EGLContextFactory {
        ...
        public EGLContext createContext(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig eGLConfig) {
            int[] iArr = {EglFactory.EGL_CONTEXT_CLIENT_VERSION, GvrSurfaceView.this.mEGLContextClientVersion, 12344};
    ...
    public class EglHelper {
            ...
            if (gvrSurfaceView == null) {
                ...
                if (gvrSurfaceView.mAppContextListener != null) {
                    ...
                    if (eGLContext2 == null || eGLContext2 == EGL10.EGL_NO_CONTEXT) {
                        ...
                        axfv axfvVar = (axfv) gvrSurfaceView.mEGLContextFactory;
                        int i = gvrSurfaceView.mAppContextListener.b;
                        axfvVar.f = eGLContext2;
                        axfvVar.d = (i & 8) == 0;
                        axfvVar.e = gvrSurfaceView.mAppContextListener.c;
                    }
                }
        ...
        public static String formatEglError(String str, int i) {
            ...
            StringBuilder sb = new StringBuilder(str.length() + 9 + String.valueOf(errorString).length());
            sb.append(str);
            sb.append(" failed: ");
    ...
    /* compiled from: PG */
    /* loaded from: classes3.dex */
    public class GLThread extends Thread implements axfw {
        ...
        /* JADX WARN: Removed duplicated region for block: B:205:0x022a A[EXC_TOP_SPLITTER, SYNTHETIC] */
        /*
