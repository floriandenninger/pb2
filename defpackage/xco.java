...
public final class xco implements xgx {
    public final String a;
    private final String b;
    private final apah c;

    public xco(String str, apah apahVar, String str2) {
        if (str == null) {
    ...
    public static xco a(String str, String str2) {
        return new xco(str, apah.TRIGGER_TYPE_BEFORE_CONTENT_VIDEO_ID_STARTED, str2);
    }
