...
public final class xha implements xew, xfv {
    public final String a;
    private final String b;
    private final apah c;

    public xha(String str, apah apahVar, String str2) {
        if (str == null) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof xha) {
            xha xhaVar = (xha) obj;
            if (this.b.equals(xhaVar.b) && this.c.equals(xhaVar.c) && this.a.equals(xhaVar.a)) {
                return true;
            }
        }
        return false;
