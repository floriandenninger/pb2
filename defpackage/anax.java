...
public class anax extends anav {
    ...
    static {
        ...
        Le:
            java.lang.String r0 = "\n"
        L10:
            defpackage.anax.a = r0
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.anax.<clinit>():void");
    }
    ...
    public static int b(String str, int i) {
        while (i < str.length()) {
            ...
            if (str.charAt(i) != '%') {
                ...
                throw anaw.c("trailing unquoted '%' character", str, i2 - 1);
            }
        }
        return -1;
    }
