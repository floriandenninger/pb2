...
/* compiled from: PG */
@wyr(a = apac.LAYOUT_TYPE_AD_MEDIA_CONTROLS_BAR, b = apae.SLOT_TYPE_LOCKSCREEN, d = {xcs.class, xcv.class, xdb.class, xdg.class, xdu.class, xel.class})
/* loaded from: classes4.dex */
public final class wtf implements wsx, wof {
    public final anhy a;
    private final wsw b;
    ...
    public wtf(wsw wswVar, Executor executor, xcl xclVar, wog wogVar, wot wotVar, xgh xghVar, xev xevVar) {
        wswVar.getClass();
        this.b = wswVar;
        executor.getClass();
        this.c = executor;
        ...
        xevVar.getClass();
        this.h = xevVar;
        this.i = (MediaAd) xghVar.d(xdu.class);
    ...
    public final void qs(String str, long j, long j2, long j3, boolean z) {
        if (whl.k(this.n, this.k.c(), this.i.c(), (int) j)) {
            this.f.b(this.l, 1);
        }
    }
    ...
    public final void qu() {
        this.e.a(this);
        whl.i(this.n, this.d, this.i.y(), this.j, this.k, this.i.g(), this.m, this.i.ae(), this.i.c());
        this.f.d(this.i.g());
        this.f.b(this.l, this.n.f().d);
        if (this.a.isDone()) {
            i(this.a);
        } else {
            this.a.d(new Runnable() { // from class: wte
