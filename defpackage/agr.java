...
public final class agr {
    ...
    public int L = 0;
    public int M = 0;
    public int N = CellularSignalStrengthError.ERROR_NOT_SUPPORTED;
    public int O = CellularSignalStrengthError.ERROR_NOT_SUPPORTED;
    public int P = CellularSignalStrengthError.ERROR_NOT_SUPPORTED;
    public int Q = CellularSignalStrengthError.ERROR_NOT_SUPPORTED;
    public int R = CellularSignalStrengthError.ERROR_NOT_SUPPORTED;
    public int S = CellularSignalStrengthError.ERROR_NOT_SUPPORTED;
    public int T = CellularSignalStrengthError.ERROR_NOT_SUPPORTED;
    public float U = -1.0f;
    public float V = -1.0f;
    public int W = 0;
    public int X = 0;
