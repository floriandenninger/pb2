...
class akjy extends algk implements axql {
    ...
    protected final void aI() {
        ...
        ehw ehwVar = (ehw) lM();
        akjvVar.ae = (ajjz) ehwVar.b.kp.get();
        akjvVar.af = ehwVar.c.jz();
        eed eedVar = ehwVar.c;
        azrw azrwVar = eedVar.f;
        azrw azrwVar2 = eedVar.I;
        efz efzVar = ehwVar.b;
        akjvVar.ag = new akht(azrwVar, azrwVar2, efzVar.lW, efzVar.lX, efzVar.a.cX);
    }
