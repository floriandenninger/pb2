...
public class alhy extends ux {
    ...
    public alhy(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public alhy(Context context, AttributeSet attributeSet, int i) {
        ...
        this.a = true;
        this.b = false;
        TypedArray a = alig.a(context, attributeSet, alia.a, i, 0, new int[0]);
