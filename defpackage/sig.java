...
public final class sig extends sio {
    final /* synthetic */ anic a;

    public sig(anic anicVar) {
        this.a = anicVar;
    }
    ...
    public final void execute(Runnable runnable) {
        this.a.execute(new sih(runnable, 0));
    }
    ...
    public final String toString() {
        ...
        StringBuilder sb = new StringBuilder(String.valueOf(sioVar).length() + 19);
