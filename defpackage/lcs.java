...
public final class lcs extends wv {
    public final TextView t;
    public final aaea u;

    public lcs(View view, final aahd aahdVar, aaea aaeaVar) {
        super(view);
        this.u = aaeaVar;
        this.t = (TextView) view.findViewById(R.id.text);
        view.findViewById(R.id.help_button).setOnClickListener(new View.OnClickListener() { // from class: lcr
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                lcs lcsVar = lcs.this;
                aahd aahdVar2 = aahdVar;
                aswb aswbVar = lcsVar.u.a().e;
                if (aswbVar == null) {
                    aswbVar = aswb.a;
                }
