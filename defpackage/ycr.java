...
public class ycr extends bv implements axql {
    ...
    protected final void aG() {
        ...
        ehw ehwVar = (ehw) lM();
        eed eedVar = ehwVar.c;
        yduVar.ah = new yfl(eedVar.I, eedVar.cu);
        yduVar.ai = (acqz) ehwVar.c.P.get();
        yduVar.aj = (aahd) ehwVar.c.I.get();
        yduVar.ak = (aarr) ehwVar.b.hV.get();
    }
