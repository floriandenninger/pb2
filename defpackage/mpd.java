...
public class mpd extends bv implements axql {
    ...
    protected final void aG() {
        ...
        this.ah = true;
        ehw ehwVar = (ehw) lM();
        ((mnu) this).ae = new mnx(ehwVar.c.a(), ehwVar.c.bc(), (ypa) ehwVar.b.B.get(), new mob(ehwVar.c.a(), (ajvb) ehwVar.c.al.get()), (DismissalFollowUpDialogFragmentController) ehwVar.c.lX.get());
    }
