...
public final class xgk implements xgi {
    public final String a;
    private final String b;
    private final apah c;

    public xgk(String str, apah apahVar, String str2) {
        if (str == null) {
    ...
    public static xgk a(String str, String str2) {
        return new xgk(str, apah.TRIGGER_TYPE_SLOT_ID_ENTERED, str2);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof xgk) {
            xgk xgkVar = (xgk) obj;
            if (this.b.equals(xgkVar.b) && this.c.equals(xgkVar.c) && this.a.equals(xgkVar.a)) {
                return true;
            }
        }
        return false;
