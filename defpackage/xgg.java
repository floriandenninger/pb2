...
public final class xgg implements xew {
    ...
    public xgg(String str, apah apahVar, String str2) {
        if (str == null) {
    ...
    public static xgg e(String str, String str2) {
        return new xgg(str, apah.TRIGGER_TYPE_SKIP_REQUESTED, str2);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof xgg) {
            xgg xggVar = (xgg) obj;
            if (this.b.equals(xggVar.b) && this.c.equals(xggVar.c) && this.a.equals(xggVar.a)) {
                return true;
            }
        }
        return false;
