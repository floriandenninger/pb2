...
public enum aosw implements aonq {
    SUBTYPE_NONE(0),
    SUBTYPE_BASE(512),
    SUBTYPE_IME(1),
    SUBTYPE_TRANSLIT(2),
    ...
    SUBTYPE_PERSONAL_MAPS_TRIP(368),
    ...
    SUBTYPE_ADAPTIVE_HOME(482),
    SUBTYPE_ADAPTIVE_HOME_SHOWN(485),
    ...
    public static aosw b(int i) {
        switch (i) {
            ...
            case 368:
                return SUBTYPE_PERSONAL_MAPS_TRIP;
            case 369:
            ...
            case 383:
                return SUBTYPE_RECENT_URL_TITLE;
            case 384:
            ...
            case 482:
                return SUBTYPE_ADAPTIVE_HOME;
            case 483:
                return SUBTYPE_YOUTUBE_CREATOR;
            case 484:
                return SUBTYPE_ORACLEMANIA;
            case 485:
                return SUBTYPE_ADAPTIVE_HOME_SHOWN;
            case 486:
    ...
    public final String toString() {
        return Integer.toString(this.jb);
    }
}
