...
public final class azhs extends AtomicInteger implements ayqd, ayqx {
    ...
    public azhs(ayqd ayqdVar, ayrv ayrvVar) {
        this.a = ayqdVar;
        this.e = ayrvVar;
    }
    ...
    public final void c(Object obj) {
        try {
            ayqm ayqmVar = (ayqm) this.e.a(obj);
            aysw.b(ayqmVar, "The mapper returned a null SingleSource");
            this.c.getAndIncrement();
            azhr azhrVar = new azhr(this);
            if (this.h || !this.b.d(azhrVar)) {
                return;
            }
            ayqmVar.Z(azhrVar);
        } catch (Throwable th) {
