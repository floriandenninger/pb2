...
public enum edt implements aonq {
    UNKNOWN_EVENT(0),
    ...
    SNO_DISCOVER_SEARCH_PLATE_TAP(879),
    TNG_DISCOVER_SEARCH_PLATE_TAP(903),
    SOI_SUGGESTIONS_RENDERED_FROM_DISCOVER(880),
    TNG_SUGGESTIONS_RENDERED_ON_TEXT_SEARCH(1405),
    ...
    DEPRECATED_MULTI_USER_ENROLLMENT_FAILED(R.styleable.AppCompatTheme_windowMinWidthMinor),
    ...
    DEPRECATED_MULTI_USER_ENROLLMENT_UTTERANCES_RECORDED(R.styleable.AppCompatTheme_windowFixedWidthMinor),
    DEPRECATED_MULTI_USER_ENROLLMENT_SUCCESS(R.styleable.AppCompatTheme_windowMinWidthMajor),
    ...
    private static final aonr WD = new ancw(1);
