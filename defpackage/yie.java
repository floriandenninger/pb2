...
public class yie extends bv implements axql {
    ...
    protected final void aG() {
        ...
        ehw ehwVar = (ehw) lM();
        eed eedVar = ehwVar.c;
        yijVar.ag = new ajyw(eedVar.cu, eedVar.I, ehwVar.b.kp, (byte[]) null, (byte[]) null, (short[]) null);
        yijVar.ae = (acqz) ehwVar.c.P.get();
        yijVar.af = (aarr) ehwVar.b.hV.get();
    }
