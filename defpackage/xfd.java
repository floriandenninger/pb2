...
public final class xfd implements xgx {
    private final String a;
    private final apah b;
    private final String c;

    public xfd(String str, apah apahVar, String str2) {
        if (str == null) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof xfd) {
            xfd xfdVar = (xfd) obj;
            if (this.a.equals(xfdVar.a) && this.b.equals(xfdVar.b) && this.c.equals(xfdVar.c)) {
                return true;
            }
        }
        return false;
