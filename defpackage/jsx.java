...
public final class jsx extends jsn {
    private final Context a;

    public jsx(Context context) {
        super(jht.class, auwd.class);
        this.a = context;
    }
    ...
    public final /* synthetic */ Object b(Object obj, amrz amrzVar) {
        ...
        createBuilder2.aS(f(a(arfr.LIKE, jhtVar.j)));
        createBuilder2.aS(f(a(arfr.DISLIKE, jhtVar.k)));
        ...
        String format = DateFormat.getLongDateFormat(context2).format(new Date(jhtVar.h.longValue()));
        aongVar10.copyOnWrite();
        ...
        aonk aonkVar2 = SlimVideoMetadataSectionRendererOuterClass.slimVideoDescriptionRenderer;
        ...
        auwaVar.c = aqygVar;
        auwaVar.b |= 1;
        aqyg aqygVar2 = jhtVar.g;
        createBuilder10.copyOnWrite();
        auwa auwaVar2 = (auwa) createBuilder10.instance;
        aqygVar2.getClass();
        auwaVar2.d = aqygVar2;
        auwaVar2.b |= 2;
        aongVar11.e(aonkVar2, (auwa) createBuilder10.build());
